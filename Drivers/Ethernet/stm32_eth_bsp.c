...
void ETH_BSP_Config(void)
{
	...
	xTaskCreate(Eth_Link_IT_task, "E_link", ETH_LINK_TASK_STACK_SIZE, (void *)DP83848_PHY_ADDRESS,
...
* @param  None
* @retval None
* @portable Redefine the GPIO port, pin or pheripheral base on your board
*/
void ETH_GPIO_Config(void)
{
	...
	/******************************* TQK Comments ****************************/
	// PA8 in ELEK STM32F107 board was used as error led output
	// and in ELEK STM32F429 board was not used
	// to make sure you have right config, undefine PHY_CLOCK_MCO pls!
	/******************************* TQK Comments ****************************/
#ifdef PHY_CLOCK_MCO	
	...
	/******************************* TQK Comments ****************************/
	// ELEK STM32F107 board was used RMII interface
	// ELEK STM32F429 board used RMII interface too.
	/******************************* TQK Comments ****************************/
	...
	/* Output HSE clock (16MHz) on MCO pin (PA8) to clock the PHY */
	RCC_MCO1Config(RCC_MCO1Source_HSE, RCC_MCO1Div_1);
#endif /* PHY_CLOCK_MCO */
	
	SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_MII);
#elif defined RMII_MODE  /* Mode RMII with STM32F102ELEK */
	
	SYSCFG_ETH_MediaInterfaceConfig(SYSCFG_ETH_MediaInterface_RMII);
#endif
	
	/******************************* TQK Comments ****************************/
	// these following lines was redefined base on ELEK STM32F107 board
	/******************************* TQK Comments ****************************/
	...
	ETH_MDIO -------------------------> PA2
	ETH_MDC --------------------------> PC1
	ETH_PPS_OUT ----------------------> PB5 // SdCard_MOSI
	ETH_MII_CRS ----------------------> PA0 // WIFI_WFS
	ETH_MII_COL ----------------------> PA3 // WIFI_CS
	ETH_MII_RX_ER --------------------> PB10
	ETH_MII_RXD2 ---------------------> PB0 // Dali_Rx1
	ETH_MII_RXD3 ---------------------> PB1 // Dali_Tx1
	ETH_MII_TX_CLK -------------------> PC3	// Driver_Out1
	ETH_MII_TXD2 ---------------------> PC2 // Driver_Out2
	ETH_MII_TXD3 ---------------------> PB8
...
//extern void SyncEthernetData(SYNC_CMD_t cmd);
extern void ChangeStaticIP(void);
